...
I show you how to do this in the <<lab2-step9,step 9>> of this lab.
...
Now I could repeat the steps from this tutorial beggining from <<lab2-step2,step 2>>.
...
* Using Docker Compose, the switching from Kafka to RabbitMQ was quite simple (after I resolve a problem with a non document step).
